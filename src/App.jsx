...
function App() {
  ...
  const visibleChange = () =>{setVisible(true)};
  const boolStr = false;
  ...
  <div>
    Strength:  <input type= "text" value={inputStrength} onChange={strengthChange} /><br></br>
    Dexterity:  <input type= "text" value={inputDexterity} onChange={dexterityChange} /><br></br>
    Constitution:  <input type= "text" value={inputConstitution} onChange={constitutionChange} /><br></br>
    Intelligence:  <input type= "text" value={inputIntelligence} onChange={intelligenceChange} /><br></br>
    Wisdom:  <input type= "text" value={inputWisdom} onChange={wisdomChange} /><br></br>
    Charisma:  <input type= "text" value={inputCharisma} onChange={charismaChange} /><br></br>
  ...
  <div>
    {isVisible && <p>
    The range of scores is from 3.5-0.175. The Highest valued classes are the
